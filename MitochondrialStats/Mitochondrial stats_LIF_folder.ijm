...
# Setup
*/
#@ File (label="Select a input directory",style="directory") path
#@ File (label="Select a output directory",style="directory") outdir
#@ File (label="Select ilastik object classification project",style="file") projectName
...
function proc1Image(path,filename,s,outdir,chMito,sigma1x,sigma2x,projectName,chDapi,scaleFactor) {
